...
class PoissonControllerNode : public rclcpp::Node{
    ...
    public:
        ...
        PoissonControllerNode() : Node("poisson_control"){
            ...
            pose_suber = this->create_subscription<geometry_msgs::msg::PoseStamped>("/MacLane_pose_internal", 1, std::bind(&PoissonControllerNode::state_update_callback, this, std::placeholders::_1), options3);
            //pose_suber = this->create_subscription<geometry_msgs::msg::PoseStamped>("/MacLane/pose", 1, std::bind(&PoissonControllerNode::state_update_callback, this, std::placeholders::_1), options3);
            //pose_suber = this->create_subscription<geometry_msgs::msg::PoseStamped>("/Shakira/pose", 1, std::bind(&PoissonControllerNode::state_update_callback, this, std::placeholders::_1), options3);
    ...
    private:
        ...
        void occ_grid_callback(nav_msgs::msg::OccupancyGrid::UniquePtr msg){
            ...
            rxc = msg->info.origin.position.x + rx + 0.38f * cosf(yaw);
            ryc = msg->info.origin.position.y + ry + 0.38f * sinf(yaw);
        ...
        void state_update_callback(geometry_msgs::msg::PoseStamped::SharedPtr data){
