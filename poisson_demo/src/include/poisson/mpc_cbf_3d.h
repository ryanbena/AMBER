...
class MPC3D{
    ...
    public: 
        ...
        void line_search(const float *h_grid, const float *dhdt_grid, const std::vector<float> xc, const float grid_age, const float wn, const int buff){
        ...
        void update_constraints(const float *h_grid, const float *dhdt_grid, const std::vector<float> x, const std::vector<float> xc, const float grid_age, const float wn, const float issf, const int buff){
